    ...
    private KeyPair getKeyPair(String publicKeyPath,String privateKeyPath){
        ...
        if (publicKeyFile.exists()&&privateKeyFile.exists()){
            try {
                ...
                EncodedKeySpec publicKeySpace = new X509EncodedKeySpec(publicKeyBytes);
                PublicKey publicKey = keyFactory.generatePublic(publicKeySpace);

                byte[] privateKeyBytes = Files.readAllBytes(privateKeyFile.toPath());
                PKCS8EncodedKeySpec privateKeySpace = new PKCS8EncodedKeySpec(privateKeyBytes);
                PrivateKey privateKey = keyFactory.generatePrivate(privateKeySpace);
